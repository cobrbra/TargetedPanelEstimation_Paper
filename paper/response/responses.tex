...
\tcnote{Thank you for this comment. Technical variation is indeed another key consideration for the accuracy of gene panel-based sequencing. We hope that our inclusion of MSK-IMPACT derived validation data in our new Section~4 demonstrates robustness to the sequencing technology employed. } \tcnote{Make sure we do this!}
