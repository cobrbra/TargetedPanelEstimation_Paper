...
\begin{itemize}
    \item We have... \tcnote{included a new Section 4 wich covers several further analyses.  different cancer types, robustness, meta analysis, TMB vs Response. } 
...
\tcnote{We can do something here, come back to it} 
